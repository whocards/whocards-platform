...
// Tolerance: up to 2% of pixels may differ (asset-hash differences, font
// sub-pixel rendering, minor layout shifts are all acceptable noise).
...
async function stableGoto(page: Page, url: string) {
 ...
 */
function normalizeDimensions(a: PNG, b: PNG): {imgA: Buffer; imgB: Buffer; w: number; h: number} {
