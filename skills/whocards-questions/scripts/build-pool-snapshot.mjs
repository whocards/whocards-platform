...
// skills/whocards-questions/scripts/build-pool-snapshot.mjs [--check]
...
const outPath = join(here, '../assets/pool-en.json')
...
if (process.argv.includes('--check')) {
  ...
  if (current !== next) {
    console.error(
      'assets/pool-en.json is stale. Run: node skills/whocards-questions/scripts/build-pool-snapshot.mjs'
    )
    process.exit(1)
  }
